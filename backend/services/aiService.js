...
function buildFallbackResponse({ mergedData, intent }) {
  ...
  if (mergedData.phone) {
    return buildResponse([
      `- ممتاز، سجلنا طلبك على المنصة ورقمك ${mergedData.phone}.`,
      ...
      legalLabel
        ...
        : '- جهز بطاقة الرقم القومي وإثبات الدخل وأي مستند متاح عن الوحدة لتسريع المراجعة.',
    ], { intent: 'lead_capture', nextStep, cta:'تم استلام طلبك بنجاح لو تحب تشوف وحدات مناسبة ليك "دوس هنا"' });
  }
      ...
      intent === 'property_search'
        ...
        : 'للموظفين براتب:',
          ...
          'كشف حساب بنكي عن آخر 6 أشهر أو إقرارات ضريبية عن آخر 3 سنوات أو قوائم مالية عن آخر 3 سنوات معتمدة من قبل مراجع خارجي مسجل لدى البنك المركزي المصري',
            'لو تحب تشوف الشروط كاملة "دوس هنا👇"'
  ...
  if (!mergedData.downPayment) {
    ...
    return buildResponse([
      ...
      mortgage?.monthlyInstallment && mergedData.income
        ...
        : null,
    ], { intent: 'mortgage_info', nextStep, cta: 'ابعت قيمة المقدم المتاح معاك ونقربك من الموافقة المبدئية 👇' });
  }
  ...
  return buildResponse([
    ...
    mortgage?.monthlyInstallment
      ...
      : null,
    '- جهز بطاقة الرقم القومي، إثبات الدخل، وأي مستندات للوحدة عشان نسرع الإجراء.',
  ], { intent: 'lead_capture', nextStep, cta:  'سيب رقمك عشان فريقنا يراجع الملف القانوني معاك 👇' });


}
  //  ── لم يُذكر الوضع القانوني بعد ───────────────────────────────────────

  // if (!mergedData.propertyLegalStatus) {
  //   return buildResponse([
  //     intent === 'property_search'
  //       ? '- في التمويل العقاري داخل مصر أهم فحص قانوني يكون للملكية، الترخيص، وعدم وجود مخالفات.'
  //       : '- أهم المستندات: عقد الملكية أو التخصيص، الرخصة، بيان عدم مخالفات.',
  //   ], { intent, nextStep, cta: 'ابعت وضع الوحدة القانوني الحالي ونراجع قابليتها للتمويل 👇' });
  // }
